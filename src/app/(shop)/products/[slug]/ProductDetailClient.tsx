...
export interface ProductDetailClientProps {
  /**
   * The product as fetched on the server. Seeding React Query with it means
   * the name, price, images, description and related-product links are all
   * present in the server-rendered HTML rather than appearing only after the
   * client-side query resolves — the difference between a crawlable product
   * page and a loading skeleton.
   *
   * Guarded on slug: during a client-side navigation between two products the
   * new slug can arrive before the new server payload does, and serving the
   * previous product's data under the new slug would show the wrong price.
   */
